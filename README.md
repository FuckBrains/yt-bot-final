...
ERROR: Could not install packages due to an EnvironmentError: [WinError 5] Access is denied: 'C:\\Users\\arjun\\AppData\\Local\\Programs\\Python\\Python38-32\\Lib\\site-packages\\~il\\_imaging.cp38-win32.pyd'
Consider using the `--user` option or check the permissions.


ec2-52-66-215-97.ap-south-1.compute.amazonaws.com
f&S8LZ=p@yy@$fd$)X)W5URqoTQ9Q;SX